...
Elm.Main.make = function (_elm) {
   ...
   var getRaw = function (uri) {
      ...
      $Http.getString(uri),
      function (e) {
         return $Task.fail($Basics.toString(e));
      });
   };
   var file = F4(function (name,
   path,
   contents,
   mime) {
      return {_: {}
      ...
      return function () {
         ...
         {case "FileE":
            return A2($Task.andThen,
              getRaw(e._0.url),
              function (s) {
                 return $Task.succeed(A4(file,
                 e._0.name,
                 e._0.path,
                 s,
                 "text/plain"));
              });}
         return $Debug.crash("raw: DirE");
      }();
   });
   var File = F4(function (a,
   b,
   c,
   d) {
      return {_: {}
   ...
   var FileE = function (a) {
      return {ctor: "FileE",_0: a};
   };
   var fileE = F3(function (name,
   path,
   url) {
      return FileE({_: {}
                   ,name: name
   ...
   var DirE = function (a) {
      return {ctor: "DirE",_0: a};
   };
   var dirE = F2(function (name,
   path) {
      return DirE({_: {}
                  ,name: name
                  ,path: path});
   });
   var decodeEntry = A2($Json$Decode.andThen,
   A2($Json$Decode.at,
   _L.fromArray(["type"]),
   $Json$Decode.string),
   function (tipe) {
      return function () {
         ...
         {case "dir":
            ...
            return A4($Json$Decode.object3,
              ...
              $Json$Decode.string),
              A2($Json$Decode.at,
              _L.fromArray(["download_url"]),
              $Json$Decode.string));}
         return $Debug.crash(A2($Basics._op["++"],
         "decodeEntry: unknown type (",
         A2($Basics._op["++"],
         tipe,
         ")")));
      }();
   });
   var index = F2(function (s,r) {
      return A2($Html.div,
      _L.fromArray([$Html$Attributes.id("index")]),
      _L.fromArray([A2($Html.h1,
                   ...
                   ,A2($Html.h2,
                   _L.fromArray([]),
                   _L.fromArray([$Html.text("Go ahead and do stuff!")]))]));
   });
   var init = A2($Html.div,
   _L.fromArray([$Html$Attributes.id("init")]),
   _L.fromArray([$Html.text("Initialising…")]));
   var ContentsC = function (a) {
      return {ctor: "ContentsC"
             ,_0: a};
   };
   var NameC = function (a) {
      return {ctor: "NameC",_0: a};
   };
   var Save = {ctor: "Save"};
   var Open = function (a) {
   ...
   var NoOp = {ctor: "NoOp"};
   var changes = $Signal.mailbox(NoOp);
   var actions = changes.signal;
   var skeleton = F2(function (_v3,
   inner) {
      return function () {
         return A2($Html.div,
         _L.fromArray([]),
         _L.fromArray([A2($Html.div,
                      _L.fromArray([$Html$Attributes.id("tree")]),
                      ...
                      function (e) {
                         return function () {
                            var i = function () {
                               ...
                               {case "DirE":
                                  return A2($Html.span,
                                    _L.fromArray([$Html$Attributes.$class("octicon octicon-file-directory")]),
                                    _L.fromArray([]));
                                  case "FileE":
                                  return A2($Html.span,
                      ...
                      _v3.tree))]))
                      ,A2($Html.div,
                      _L.fromArray([$Html$Attributes.id("inner")]),
                      _L.fromArray([inner]))]));
      }();
   });
   var edit = F2(function (s,r) {
      return A2($Html.div,
      _L.fromArray([$Html$Attributes.id("edit")]),
      _L.fromArray([A2($Html.input,
                   _L.fromArray([$Html$Attributes.value(r.file.name)
                                ,$Html$Attributes.placeholder("File name")
                                ,A3($Html$Events.on,
                                "change",
                                A2($Json$Decode.at,
                                _L.fromArray(["target"
                   ...
                   _L.fromArray([$Html.text(r.file.contents)]))
                   ,A2($Html.a,
   ...
   var FileL = function (a) {
      return {ctor: "FileL",_0: a};
   };
   var InitL = {ctor: "InitL"};
   var Edit = function (a) {
      ...
      return function () {
         ...
         {case "ContentsC":
            return function () {
                 ...
                 {case "Edit":
                    return _U.replace([["mode"
                                       ,Edit({_: {}
                                             ,file: _U.replace([["contents"
                                                                ,act._0]],
                                             _v20._0.file)})]],
                      s);}
                 return $Debug.crash("ContentsC");
              }();
            case "NameC":
            return function () {
                 var _v22 = s.mode;
                 ...
                 {case "Edit":
                    return _U.replace([["mode"
                                       ,Edit({_: {}
                                             ,file: _U.replace([["name"
                                                                ,act._0]],
                                             _v22._0.file)})]],
                      s);}
                 return $Debug.crash("NameC");
              }();
            case "Open":
            return _U.replace([["mode"
                               ,Edit({_: {},file: act._0})]
            ...
            return _U.replace([["mode"
              ...
              s);
            case "Select":
            return _U.replace([["load"
                               ,$Maybe.Just(FileL(act._0))]],
              s);
            case "Tree":
            return _U.replace([["tree"
                               ,act._0]
                              ,["load",$Maybe.Nothing]],
              s);}
         return s;
   ...
   var accessToken = Elm.Native.Port.make(_elm).inbound("accessToken",
   "String",
   function (v) {
            ...
            return function () {
               ...
               {case "Text":
                  return function () {
                       ...
                       parser,
                       A2($Debug.log,"json",_v26._0));
                       switch (_v28.ctor)
                       {case "Err":
                          return $Task.fail(_v28._0);
                          case "Ok":
   ...
   var github = Elm.Native.Task.make(_elm).performSignal("github",
   function () {
      var fileL = F2(function (s,
      path) {
         return A2($Task.andThen,
         A3(raw,s.user,s.repo,path),
         function (fn) {
      ...
      var initL = function (s) {
         return A2($Task.andThen,
         A2(tree,s.user,s.repo),
         function (fns) {
            return A2($Signal.send,
            changes.address,
            Tree(fns));
      ...
      function (s) {
         return function () {
            ...
            {case "Just":
               switch (_v31._0.ctor)
                 {case "FileL": return A2(fileL,
                      s,
                      _v31._0._0);
                    case "InitL": return initL(s);}
                 break;}
